...
#import "GRTMasterViewController.h"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *message = _objects[indexPath.row];
    cell.textLabel.text = [message objectForKey:@"title"];
    cell.detailTextLabel.text = [message objectForKey:@"location"];
    return cell;
}
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    _objects = [NSJSONSerialization JSONObjectWithData:_data options:0 error:nil];
